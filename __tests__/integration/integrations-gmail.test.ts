...
function req(method='GET', body?:unknown, url='http://localhost:3008/api/integrations/gmail'): NextRequest {
  const init: Record<string,unknown> = { method };
  if (body) { init.body=JSON.stringify(body); init.headers={'Content-Type':'application/json'}; }
  return new NextRequest(new URL(url), init);
}

describe('GET /api/integrations/gmail', () => {
...
describe('POST /api/integrations/gmail', () => {
