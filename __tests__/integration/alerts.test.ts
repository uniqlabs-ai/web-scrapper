...
vi.mock('@/lib/prisma', () => ({
  prisma: {
    ...
    expense: { aggregate: vi.fn().mockResolvedValue({ _sum: { amount: 50000 }, _count: { id: 5 } }) },
    ...
    recurringExpense: { count: vi.fn().mockResolvedValue(5) },
...
function req(method='GET', body?:unknown, url='http://localhost:3008/api/alerts'): NextRequest {
