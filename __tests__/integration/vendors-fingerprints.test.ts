...
function req(method='GET', body?:unknown, url='http://localhost:3008/api/vendors/fingerprints'): NextRequest {
...
describe('POST /api/vendors/fingerprints', () => {
